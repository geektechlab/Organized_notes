 ...
 * =====================================================================================
 *
 *       Filename:  hello_world_terminate_parent_keep_child_alive.c
 *
...
/*
 * compile using :
 * gcc -g -c hello_world_terminate_parent_keep_child_alive.c -o hello_world_terminate_parent_keep_child_alive.o
 * gcc -g hello_world_terminate_parent_keep_child_alive.o -o hello_world_terminate_parent_keep_child_alive.exe -lpthread
 * Run : ./hello_world_terminate_parent_keep_child_alive.exe
 */
