/* compile: gcc -g -c server_for_multiple_clients.c -o server_for_multiple_clients.o
   link:    gcc -g server_for_multiple_clients.o -o server_for_multiple_clients -lrt
   run: ./server_for_multiple_clients running as daemon somehow doesn't work */
