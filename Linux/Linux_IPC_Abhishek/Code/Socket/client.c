/* compile: gcc -g -c client.c -o client.o
   link:    gcc -g client.o -o client -lrt
   we can run both processes in single shell using daemon process. run ./client& to create daemon */
