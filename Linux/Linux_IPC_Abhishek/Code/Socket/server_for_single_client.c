/* compile: gcc -g -c server_for_single_client.c -o server_for_single_client.o
   link:    gcc -g server_for_single_client.o -o server_for_single_client -lrt
   we can run both processes in single shell using daemon process. run ./server_for_single_client& to create daemon */
