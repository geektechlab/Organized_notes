/* compile: gcc -g -c recvr.c -o recvr.o
   link:    gcc -g recvr.o -o recvr -lrt
   we can run both processes in single shell using daemon process. run ./recvr& to create daemon */
