/* compile: gcc -g -c sender.c -o sender.o
   link:    gcc -g sender.o -o sender -lrt
   we can run both processes in single shell using daemon process. run ./sender& to create daemon */
