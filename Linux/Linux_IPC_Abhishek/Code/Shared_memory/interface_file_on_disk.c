/* compile: gcc -g -c interface_file_on_disk.c -o interface_file_on_disk.o
   link:    gcc -g interface_file_on_disk.o -o interface_file_on_disk -lrt
   we can run both processes in single shell using daemon process. run ./interface_file_on_disk& to create daemon */
