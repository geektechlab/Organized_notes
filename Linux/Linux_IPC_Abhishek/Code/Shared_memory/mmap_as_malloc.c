/* compile: gcc -g -c mmap_as_malloc.c -o mmap_as_malloc.o
   link:    gcc -g mmap_as_malloc.o -o mmap_as_malloc -lrt
   we can run both processes in single shell using daemon process. run ./mmap_as_malloc& to create daemon */
