...
/**
  ...
  * @retval int
  */
/* Here we are defining task stack and scheduler stack as following:
 * ->	RAM END ( highest address because stack starts from top and ARM has full descending stack )
 * ->	1kB stack for task1
 * ->	1kB stack for task2
 * ->	1kB stack for task3
 * ->	1kB stack for task4
