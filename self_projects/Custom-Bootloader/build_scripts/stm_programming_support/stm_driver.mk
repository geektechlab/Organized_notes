# Makefile to build target application from <ROOT>/boot_scripts
ifneq ($(CI),true)
    LD:=arm-none-eabi-gcc
endif

APP?=uart
APPDIR=$(ROOT_FOLDER)/boot_scripts/build/$(APP)
OBJDIR=$(ROOT_FOLDER)/boot_scripts/build/$(APP)/generated_files
...
INCLUDES+=-I$(ROOT_FOLDER)/boot_scripts/$(APP)
...
SRCS+=$(wildcard $(ROOT_FOLDER)/boot_scripts/$(APP)/*.c)
